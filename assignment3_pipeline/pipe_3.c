...
//
//void Fetch(Latch* IF_ID, Latch* EX_MEM, Count_num* count_num);
...
//void Latch_copy(Latch* input, Latch* output)
//{
//	memcpy(input, output, sizeof(Latch));
//}
//
//int Mux(int input1, int input2, int signal)
//{
...
//			Latch_Set(IF_ID);
//		}
//		if (ctrl_dep_Branch > 0)
//		{
//			Latch_Set(IF_ID);
//		}
//		else;	// Branch not taken & else
//	} // ctrl_dep_ jump = 1 & branch = 3
//	IF_ID->pc = nPC;
...
//	while (PC != 0xffffffff)
//	{
//		Fetch(&latch[0], &latch[5], &count_num);
