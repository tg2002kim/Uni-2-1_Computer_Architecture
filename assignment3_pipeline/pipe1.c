...
//void ALU_Ctrl_signal(Latch* IF_ID, Count_num* count);
...
//void BTB_detection(Latch* IF_ID);
//
...
//	}	// R-type inst
//
//	else if (((IF_ID->opcode == 0x0) && (IF_ID->funct == 0x8)) || (IF_ID->opcode == 0x2) || (IF_ID->opcode == 0x3))
//	{
//		IF_ID->Jump = 1;
//	}	// JR, Jump, JAL
//
//	else if ((IF_ID->opcode == 0x4) || (IF_ID->opcode == 0x5))
//	{
//		IF_ID->Branch = 1;
//	}	// BEQ, BNE
//
//	else if (IF_ID->opcode == 0x23)
//	{
//		IF_ID->MemRead = 1;
//		IF_ID->Mem2Regs = 1;
//	}	// LW
//
//	else if (IF_ID->opcode == 0x2b)
//	{
//		IF_ID->MemWrite = 1;
//	}	// SW
//
//	else if ((IF_ID->opcode != 0) && (IF_ID->opcode != 0x4) && (IF_ID->opcode != 0x5))
//	{
//		IF_ID->ALUSrc = 1;
//	}	// Not R_type, BEQ, BNE
//
//	else if ((IF_ID->opcode != 0x2b) && (IF_ID->opcode != 0x4) && (IF_ID->opcode != 0x5) && (IF_ID->opcode != 0x2) && (!((IF_ID->opcode == 0x0) && (IF_ID->funct == 0x8))))
//	{
//		IF_ID->RegWrite = 1;
...
//	BTB_detection(IF_ID);
//	if (BTB_ex == 1);	// BTB_detection()에서 nPC값 수정됨 
//	else if (BTB_ex == 0) // history에 없는 pc값 실행
//	{
...
//		if (ctrl_dep_count < 1)
//		{
//			if (ctrl_dep == 1)	// jump 실행시 => Fetch 버블
//			{
//				while (nPC != 0xffffffff)
//				{
//					Latch_Set(IF_ID);
//					PC = nPC;
//					return;
...
//	ALU_Ctrl_signal(IF_ID, count_num);
...
//			ctrl_dep = 1;
//		}
//		if (BTB_ex != 1)		// BTB에 기록X
//		{
//			if ((ID_EX->Branch && ID_EX->ALU_result) == 1)
//			{
//				ctrl_dep = 1;
//				BTB_Insert(ID_EX->pc, ID_EX->JumpAddr + ID_EX->pc + 4, 1);
...
//}
//
//void printLatch(Latch* latch, int type) 
//{
//	switch (type)
//	{
//	case 1:	// inst
